...
echo -e "\033[0;34m│ $NC${BIGREEN}[${BIWhite}10${BIGREEN}] ${BIWhite}${NC}BACKUP/RESTORE ${BIGREEN}${BIYellow}${BIGREEN}${NC}         ${BIGREEN}[${BIWhite}00${BIGREEN}] ${NC} EXIT ${BIGREEN}${BIYellow}${BIGREEN}${NC}"  
