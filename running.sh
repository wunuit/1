...
Stunnel=$(systemctl status stunnel5 | grep active | awk '{print $3}' | sed 's/(//g' | sed 's/)//g')
...
echo -e "\033[1;93m─────────────────────────────────────\033[0m"
echo -e "${Blue}Service Stunnel5$NC            $grenbo:$NC $status_8"
echo -e "${Blue}Service Open_SSH$NC            $grenbo:$NC $status_1"
echo -e "${Blue}Service Dropbear$NC            $grenbo:$NC $status_2"
echo -e "${Blue}Service SSH_Websocket$NC       $grenbo:$NC $status_3"
echo -e "${Blue}Service Nginx_Webserver$NC     $grenbo:$NC $status_4"
echo -e "${Blue}Service Xray_Vmess_TLS$NC      $grenbo:$NC $status_5"
echo -e "${Blue}Service Xray_Vmess_gRPC$NC     $grenbo:$NC $status_5"
echo -e "${Blue}Service Xray_Vmess_None_TLS$NC $grenbo:$NC $status_5"
echo -e "${Blue}Service Xray_Vless_TLS$NC      $grenbo:$NC $status_5"
echo -e "${Blue}Service Xray_Vless_gRPC$NC     $grenbo:$NC $status_5"
echo -e "${Blue}Service Xray_Vless_None_TLS$NC $grenbo:$NC $status_5"
echo -e "${Blue}Service Trojan_gRPC$NC         $grenbo:$NC $status_5"
echo -e "${Blue}Service Trojan_WS$NC           $grenbo:$NC $status_5"
echo -e "${Blue}Service Shadowsocks_WS$NC      $grenbo:$NC $status_5"
echo -e "${Blue}Service Shadowsocks_gRPC$NC    $grenbo:$NC $status_5"
echo -e "${Blue}Service Iptables$NC            $grenbo:$NC $status_6"
echo -e "${Blue}Service RClocal$NC             $grenbo:$NC $status_7"
echo -e "${Blue}Service Autoreboot$NC          $grenbo:$NC $status_7"
echo -e "\033[1;93m─────────────────────────────────────\033[0m"
echo ""
